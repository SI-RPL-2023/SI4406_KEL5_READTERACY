        ...
        <div class="h-100 row d-flex align-items-stretch">
            ...
            <div class="col-12 col-md-7 col-lg-6 col-xl-5 d-flex align-items-start flex-column px-vw-5">
                ...
                <main class="mb-auto col-12">
                    ...
                    <form class="row" method="post" action="/account/register/store">
                        @csrf
                        <div class="col-12">
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-white btn-xl mb-3">Daftar!</button>
                            <p>Have some account? <a href="/account/login-page" class="mt-5" style="text-decoration: none;"> Come Here</a></p>
                        </div>
                    </form>
