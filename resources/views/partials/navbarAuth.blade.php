                ...
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0 list-group list-group-horizontal">
                    ...
                    <li class="nav-item">
                        <div class="dropdown">
                            ...
                            <div class="option">
                                <div onclick="show('Historical')"><ion-icon name="planet"></ion-icon><a style="text-decoration: none;" class="text-white" href="/Readteracy/genre/Historical">Sejarah</a></div>
                                <div onclick="show('Education')"><ion-icon name="book"></ion-icon><a style="text-decoration: none;" class="text-white" href="/Readteracy/genre/Education">Edukasi</a></div>
