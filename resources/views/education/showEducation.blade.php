@if (Auth::user())
    ...
    <head>
        ...
        <title>Readteracy - Education genre</title>
    ...
    <body class="bg-black text-white mt-0">
                    ...
                    <div class="w-100 overflow-hidden position-relative bg-black text-white">
                        ...
                        <div class="container py-vh-4 position-relative mt-5 px-vw-5 text-center">
                            <div class="row d-flex align-items-center justify-content-center py-vh-5">
                                ...
                                <h1 class="display-huge mt-3 mb-3 lh-1">Education</h1>
                                <div class="col-12 col-xl-8">
                                    <p class="lead text-secondary">
                                        Salah satu jenis genre buku atau literatur yang fokus pada pembelajaran dan pendidikan.
                                        Buku dengan genre Education dapat mencakup berbagai topik, seperti matematika, sains, sejarah, seni, teknologi, bisnis, dan lain-lain.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col mt-5">
                    <h1 class="mt-5 text-center text-white">Education</h1>
                    @if (Auth::user()->role == 1 || Auth::user()->role == 2)
                        <div class="mx-auto text-center">
                            <a href="/Readteracy/education/addBook" class="btn btn-light">Tambah Data</a>
                        </div>
                    @endif
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                ...
                                                <div class="justify-content-end mx-3">
                                                    <small><a href="#" class="link-fancy link-fancy-black">Read More</a></small>
